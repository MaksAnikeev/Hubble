...
def fetch_space_pictures_from_nasa(pictures_quantity, picture_path, nasa_api_key):
...
if __name__ == '__main__':
    ...
    fetch_space_pictures_from_nasa(pictures_quantity=namespace.pictures_quantity,
